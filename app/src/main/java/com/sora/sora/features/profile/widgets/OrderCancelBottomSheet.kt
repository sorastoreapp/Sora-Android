    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            CustomMontserratText(
                text = "Are you sure you want to cancel your order #$orderId?",
                fontSize = 16.sp,
                color = Color.Black,
            ...
            // Additional message
            CustomMontserratText(
                text = "Once canceled, this action cannot be undone. Refunds will be processed within 5-7 business days.",
                fontSize = 13.sp,
                color = Color.Gray,
                modifier = Modifier
